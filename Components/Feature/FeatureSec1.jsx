...
const FeatureSec1 = () => {
  return (
    <section className="text-white body-font py-10 flex justify-center items-center max-sm:overflow-hidden">
      <div className="lg:max-w-[1440px] w-[90%] md:px-10 flex max-lg:flex-wrap lg:gap-3 justify-between">
        <div className="flex w-full flex-col gap-6 justify-center text-center lg:w-1/2 md:pr-10">
          ...
          <FeatureItem
            ...
            title={
              <>
                <strong>Buy & Sell:</strong> <span className="text-gray-200 lg:text-2xl">Crypto OTC Trading platform</span>
              </>
            }
