  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center">
        <div className="flex flex-col gap-y-4 lg:max-w-[1440px] w-[90%] px-3 md:px-10 py-10 lg:py-5 items-center relative mt-28 text-white">
          <h1 className="text-3xl z-50 font-bold float-left w-full">FAQ</h1>
          <p className=" z-50 mb-2 w-full">
            Helps new and existing users quickly find answers to common
            questions.
          </p>
          {PPC.map((pp, index) => {
            return (
